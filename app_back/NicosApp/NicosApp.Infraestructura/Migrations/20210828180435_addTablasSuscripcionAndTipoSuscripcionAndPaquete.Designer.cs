...
namespace NicosApp.Infraestructura.Migrations
{
    ...
    [Migration("20210828180435_addTablasSuscripcionAndTipoSuscripcionAndPaquete")]
    partial class addTablasSuscripcionAndTipoSuscripcionAndPaquete
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NicosApp.Core.Entidades.Paquete", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("NicosApp.Core.Entidades.Suscripcion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<Guid>("IdTipoSuscripcion")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NicosApp.Core.Entidades.TipoSuscripcion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("NicosApp.Core.Entidades.Suscripcion", b =>
                {
                    b.HasOne("NicosApp.Core.Entidades.ApplicationUser", "ApplicationUser")
                        .WithMany("Suscripciones")
                        .HasForeignKey("IdApplicationUser")
                        .HasConstraintName("FK_Suscripcion_User");

                    b.HasOne("NicosApp.Core.Entidades.Paquete", "Paquete")
                        .WithMany("Suscripciones")
                        .HasForeignKey("IdPaquete")
                        .HasConstraintName("FK_Suscripcion_Paquete")
                        .IsRequired();

                    b.HasOne("NicosApp.Core.Entidades.TipoSuscripcion", "TipoSuscripcion")
                        .WithMany("Suscripciones")
